...
4. Create a `.dev.env` file and add the following variables:
    ...
    - `CONFIG_KV_NAMESPACE_ID` - The ID of the KV namespace
5. Set production environment variables by running `wrangler secret put` for each secret variable and set KV namespace ID in GitHub Actions secrets
